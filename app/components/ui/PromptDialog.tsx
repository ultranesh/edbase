        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 pt-1">
            ...
            <input
              ...
              className="mt-4 w-full px-4 py-3 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            />
          </div>
        </div>
