...
async function main() {
  ...
  const userRoles = [
    ...
    { code: 'COORDINATOR_MANAGER', name: 'Руководитель координатора', nameKz: 'Үйлестіруші жетекшісі', nameRu: 'Руководитель координатора', nameEn: 'Coordinator Manager', orderIndex: 6 },
